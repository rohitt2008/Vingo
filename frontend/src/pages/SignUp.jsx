    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          <button  className={`w-full font-semibold py-2 rounded-lg transition duration-200 hover:bg-[#e64323] text-white bg-[#ff4d2d]  cursor-pointer`} onClick={handleSignUp} disabled={loading}>
