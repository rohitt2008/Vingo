      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <button className="absolute right-3 top-[14px] cursor-pointer text-gray-500" onClick={()=>{
        ...
        <div className='text-right mb-4 cursor-pointer text-[#ff4d2d] font-medium' onClick={()=>navigate("/forgot-password") }>
          ...
          <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 hover:bg-[#e64323] text-white bg-[#ff4d2d]  cursor-pointer`} onClick={handleSignIn} disabled={loading}>
